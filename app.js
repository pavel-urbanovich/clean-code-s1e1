...
var taskInput=document.querySelector(".input-text");//Add a new task.
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("task-list__item_mode");
    ...
    listItem.classList.toggle("task-list__item_mode");
};
